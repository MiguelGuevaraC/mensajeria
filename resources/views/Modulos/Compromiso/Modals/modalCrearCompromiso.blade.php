<!-- Modal CREAR -->
<div class="modal fade" id="modalNuevoCompromiso" tabindex="-1" role="dialog" aria-labelledby="nuevoModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="registroCompromiso" enctype="multipart/form-data">
                    @csrf
                    <div class="row">
                        <div class="col-md-12">
