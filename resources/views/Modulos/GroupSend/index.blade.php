...
<body>
                ...
                <div id="page-content">
                    ...
                    <div class="panel">
                        ...
                        <div class="panel-body">
                            @include('Modulos.GroupSend.Tables.tablaGroupSend')
                        </div>
                    </div>
    ...
    <!--Modals [ SAMPLE ]-->
    <script src="{{ asset('js/JqueryGroupSend/JqueryIndexGroupSend.js') }}"></script>
    <script src="{{ asset('js/JqueryGroupSend/JqueryDestroyGroupSend.js') }}"></script>
    <script src="{{ asset('js/JqueryGroupSend/JqueryCreateGroupSend.js') }}"></script>
    <script src="{{ asset('js/JqueryGroupSend/JqueryEditGroupSend.js') }}"></script>
    <script src="{{ asset('js/JqueryGroupSend/JqueryUpdateGroupSend.js') }}"></script>
