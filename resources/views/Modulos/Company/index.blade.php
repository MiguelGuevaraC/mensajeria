...
<body>
    ...
    <!-- MODALES -->
    <div>@include('Modulos.Company.Modals.modalEditarCompany')</div>

    <div>@include('Modulos.Company.Modals.modalCrearCompany')</div>
    ...
    <!--Modals [ SAMPLE ]-->
    <script src="{{ asset('js/JqueryCompany/JqueryIndexCompany.js') }}"></script>
    <script src="{{ asset('js/JqueryCompany/JqueryDestroyCompany.js') }}"></script>
    <script src="{{ asset('js/JqueryCompany/JqueryCreateCompany.js') }}"></script>
    <script src="{{ asset('js/JqueryCompany/JqueryEditCompany.js') }}"></script>
    <script src="{{ asset('js/JqueryCompany/JqueryUpdateCompany.js') }}"></script>
