...
<body>
                ...
                <div id="page-content">
                    ...
                    <div class="panel">
                        ...
                        <div class="panel-body">
                            @include('Modulos.User.Tables.tablaUser')
                        </div>
                    </div>
    ...
    <!-- MODALES -->
    <div>@include('Modulos.User.Modals.modalEditarUser')</div>

    <div>@include('Modulos.User.Modals.modalCrearUser')</div>
    ...
    <!--Modals [ SAMPLE ]-->
    <script src="{{ asset('js/JqueryUser/JqueryIndexUser.js') }}"></script>
    <script src="{{ asset('js/JqueryUser/JqueryDestroyUser.js') }}"></script>
    <script src="{{ asset('js/JqueryUser/JqueryCreateUser.js') }}"></script>
    <script src="{{ asset('js/JqueryUser/JqueryEditUser.js') }}"></script>
    <script src="{{ asset('js/JqueryUser/JqueryUpdateUser.js') }}"></script>
